...
void ATriggerShape::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
    ...
    if (PropertyName == GET_MEMBER_NAME_CHECKED(FBoxCollision, X) || PropertyName ==
        GET_MEMBER_NAME_CHECKED(FBoxCollision, Y) || PropertyName == GET_MEMBER_NAME_CHECKED(FBoxCollision, Z))
    {
    ...
    if (PropertyName == GET_MEMBER_NAME_CHECKED(FCapsuleCollision, CapsuleHalfHeight) || PropertyName ==
        GET_MEMBER_NAME_CHECKED(FCapsuleCollision, CapsuleRadius))
    {
...
bool ATriggerShape::CanEditChange(const FProperty* InProperty) const
{
    ...
    if (PropertyName == GET_MEMBER_NAME_CHECKED(ATriggerShape, BoxCollision) || PropertyName ==
        GET_MEMBER_NAME_CHECKED(ATriggerShape, SphereCollision) || PropertyName == GET_MEMBER_NAME_CHECKED(
            ATriggerShape, CapsuleCollision))
    {
